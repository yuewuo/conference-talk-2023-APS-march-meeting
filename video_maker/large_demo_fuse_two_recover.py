...
FOLDER = "screenshots_large_demo_fuse_two_recover"
common.create_folder(FOLDER)

WIDTH = 3840
HEIGHT = 2160
URL = f"http://localhost:8095/index.html?animation=large_demo_fuse_two_recover&scale=2"
FRAME_RATE = 60
...
with common.ScreenshotMaker(URL, WIDTH, HEIGHT, sleep_interval=0.5, headless=False) as maker:
    ...
    with alive_bar(count) as bar:
        for frame in range(count):
            ...
            bar()
    maker.make_video(FRAME_RATE, "large_demo_fuse_two_recover.mp4")
