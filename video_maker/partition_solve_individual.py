...
FOLDER = "screenshots_partition_solve_individual"
common.create_folder(FOLDER)

WIDTH = 2000
HEIGHT = 2000
URL = f"http://localhost:8095/index.html?animation=partition_solve_individual&scale=2"
FRAME_RATE = 60
...
with common.ScreenshotMaker(URL, WIDTH, HEIGHT, sleep_interval=0.5, headless=False) as maker:
    ...
    with alive_bar(count) as bar:
        for frame in range(count):
            ...
            bar()
    maker.make_video(FRAME_RATE, "partition_solve_individual.mp4")
