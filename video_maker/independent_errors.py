...
FOLDER = "screenshots_independent_errors"
common.create_folder(FOLDER)

SCALE = 1 / common.device_pixel_ratio
WIDTH = int(1000 * SCALE)
HEIGHT = int(1000 * SCALE)
URL = f"http://localhost:8095/index.html?animation=independent_errors&scale={SCALE}"
FRAME_RATE = 30
...
with common.ScreenshotMaker(URL, WIDTH, HEIGHT) as maker:
    ...
    with alive_bar(count) as bar:
        for frame in range(count):
            ...
            bar()
    maker.make_video(FRAME_RATE, "independent_errors.mp4")
