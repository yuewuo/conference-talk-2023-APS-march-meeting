...
FOLDER = "screenshots_example_both_grow_single_2"
common.create_folder(FOLDER)

WIDTH = 4500
HEIGHT = 2000
URL = f"http://localhost:8095/index.html?animation=example_both_grow_single_2&scale=2"
FRAME_RATE = 60
...
with common.ScreenshotMaker(URL, WIDTH, HEIGHT, sleep_interval=0.5, headless=False) as maker:
    ...
    with alive_bar(count) as bar:
        for frame in range(count):
            ...
            bar()
    maker.make_video(FRAME_RATE, "example_both_grow_single_2.mp4")
